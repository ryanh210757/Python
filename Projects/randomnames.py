...
# Choose a first name randomly
# Assign name to variable
# Choose last name randomly
# Assign last name to variable
# Print names to the screen in order
...
def getrandomname():
    ...
    print(f'\nGenerating name...\n')
    print(f'\n Your new name is {first_name} {last_name}!\n')

    print("Would you like to get a new name?\n")


    while True:
        playagain = input("Enter Y to get new name or Q to quit")
